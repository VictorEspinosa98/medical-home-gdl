...
export const FAQ: Record<Locale, Faq[]> = {
  es: [
    ...
    },
    {
      ...
      a: 'La primera consulta médica a domicilio cuesta desde $850 MXN en Guadalajara y su Zona Metropolitana. El precio final depende del servicio y de la zona: te confirmamos el costo exacto por WhatsApp antes de agendar, sin compromiso.',
    },
    {
